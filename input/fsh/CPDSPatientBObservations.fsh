...
Instance: CPDSCaseSummaryGrouperB
...
* hasMember = Reference(CPDSClinicalHistoryObservationB)
* hasMember = Reference(CPDSFunctionalStatusObservationB)
* subject = Reference(CPDSPatientB)

Instance: CPDSClinicalHistoryObservationB
InstanceOf: Observation
Usage: #inline
...
Instance: CPDSFunctionalStatusObservationB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/ihe-sdc-ecc-Observation"
* identifier.system = "https://cap.org/eCC"
...
* hasMember = Reference(CPDSProcedureObservationB)
* subject = Reference(CPDSPatientB)
...
Instance: CPDSProcedureObservationB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/ihe-sdc-ecc-Observation"
* identifier.system = "https://cap.org/eCC"
...
* hasMember = Reference(CPDSHistologicTypeObservationB)
* hasMember = Reference(CPDSHistologicGradeObservationB)
* subject = Reference(CPDSPatientB)
...
Instance: CPDSHistologicTypeObservationB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/ihe-sdc-ecc-Observation"
* identifier.system = "https://cap.org/eCC"
...
Instance: CPDSHistologicGradeObservationB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/ihe-sdc-ecc-Observation"
* identifier.system = "https://cap.org/eCC"
...
Instance: CPDSLymphNodesGrouperB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/us-pathology-grouper-observation"
* identifier.system = "https://cap.org/eCC"
...
Instance: CPDSPathologicStageGrouperB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/us-pathology-grouper-observation"
* identifier.system = "https://cap.org/eCC"
...
Instance: CPDSAdditionalFindingsGrouperB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/us-pathology-grouper-observation"
* identifier.system = "https://cap.org/eCC"
...
Instance: CPDSSpecialStudiesGrouperB
InstanceOf: Observation
Usage: #inline
* meta.profile = "http://hl7.org/fhir/us/cancer-reporting/StructureDefinition/us-pathology-grouper-observation"
* identifier.system = "https://cap.org/eCC"
